...
Rodiny z ČR budou muset za léčbou vycestovat do některé země Evropské unie. ADNP asociace je nyní ve spojení s koordinátory a usiluje o vstup do klinického hodnocení v Polsku.

Do klinického hodnocení mohou vstoupit děti ve věku od 3 do 16 let a 11 měsíců. V první fázi bude látka podávána jen 21 dětem ve věku od 6 let.  Po úspěšných testech bezpečnosti se látka začne podávat i dětem ve věku od 3 let. Tento postup je běžný v klinických studiı́ch, protože zajišťuje postupný a bezpečný přı́stup k testovánı́ léčby na citlivějšı́ch věkových skupinách. 
...
NAP peptid hraje klíčovou roli v ochraně neuronů a stabilizaci mikrotubulů, které jsou nezbytné pro správné fungování buněčného transportního systému. Dysfunkce ADNP proteinu vede zpravidla k hyperfosforylaci TAU proteinu, což oslabuje jeho vazbu na mikrotubuly. Výsledkem je destabilizace mikrotubulů a narušení axonálního transportu. TAU protein se uvolňuje a může se hromadit v cytoplazmě ve formě neurofibrilárních klubek. Výsledkem je postupná degradace neuronů, která může vést k neurodegenerativním změnám až apoptóze. NAP peptid dokáže tento proces stabilizovat tím, že podporuje správnou polymerizaci mikrotubulů, stabilizuje jejich strukturu a chrání neurony před degenerativními změnami.
...
- [ADNP syndrom: Klinické indikační markery pro cílené genetické testování](https://adnpasociace.cz/clanky/adnp-syndrom-klinicke-indikacni-markery)
